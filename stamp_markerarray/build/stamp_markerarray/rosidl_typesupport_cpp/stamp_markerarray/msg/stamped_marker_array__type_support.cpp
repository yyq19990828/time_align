...
static const _StampedMarkerArray_type_support_symbol_names_t _StampedMarkerArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stamp_markerarray, msg, StampedMarkerArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, stamp_markerarray, msg, StampedMarkerArray)),
  }
};
...
{
  return &::stamp_markerarray::msg::rosidl_typesupport_cpp::StampedMarkerArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, stamp_markerarray, msg, StampedMarkerArray)() {
  return get_message_type_support_handle<stamp_markerarray::msg::StampedMarkerArray>();
}
