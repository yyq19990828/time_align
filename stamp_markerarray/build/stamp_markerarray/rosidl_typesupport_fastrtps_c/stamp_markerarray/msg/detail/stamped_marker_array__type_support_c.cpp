...
#include "stamp_markerarray/msg/detail/stamped_marker_array__rosidl_typesupport_fastrtps_c.h"
...
#include "stamp_markerarray/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_stamp_markerarray
...
using _StampedMarkerArray__ros_msg_type = stamp_markerarray__msg__StampedMarkerArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _StampedMarkerArray__ros_msg_type * ros_message = static_cast<const _StampedMarkerArray__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _StampedMarkerArray__ros_msg_type * ros_message = static_cast<_StampedMarkerArray__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stamp_markerarray
size_t get_serialized_size_stamp_markerarray__msg__StampedMarkerArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _StampedMarkerArray__ros_msg_type * ros_message = static_cast<const _StampedMarkerArray__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _StampedMarkerArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_stamp_markerarray__msg__StampedMarkerArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stamp_markerarray
size_t max_serialized_size_stamp_markerarray__msg__StampedMarkerArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stamp_markerarray__msg__StampedMarkerArray;
    is_plain =
      (
...
static size_t _StampedMarkerArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_stamp_markerarray__msg__StampedMarkerArray(
...
static message_type_support_callbacks_t __callbacks_StampedMarkerArray = {
...
static rosidl_message_type_support_t _StampedMarkerArray__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_StampedMarkerArray,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stamp_markerarray, msg, StampedMarkerArray)() {
  return &_StampedMarkerArray__type_support;
}
