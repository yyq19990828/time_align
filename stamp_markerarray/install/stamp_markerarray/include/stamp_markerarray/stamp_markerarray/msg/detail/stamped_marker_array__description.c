...
ROSIDL_GENERATOR_C_PUBLIC_stamp_markerarray
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xa2, 0x46, 0x1e, 0x58, 0x27, 0x41, 0x5e, 0xce,
      0xb2, 0x57, 0x25, 0x35, 0x3d, 0x17, 0x30, 0xed,
      0xf5, 0x75, 0x3f, 0x62, 0xcc, 0x7e, 0xd4, 0x68,
      0xec, 0x1c, 0xa3, 0xf2, 0x4e, 0xe4, 0xfd, 0x42,
    }};
  return &hash;
}
...
static char stamp_markerarray__msg__StampedMarkerArray__TYPE_NAME[] = "stamp_markerarray/msg/StampedMarkerArray";
...
static char stamp_markerarray__msg__StampedMarkerArray__FIELD_NAME__header[] = "header";
static char stamp_markerarray__msg__StampedMarkerArray__FIELD_NAME__markers[] = "markers";

static rosidl_runtime_c__type_description__Field stamp_markerarray__msg__StampedMarkerArray__FIELDS[] = {
  {
    {stamp_markerarray__msg__StampedMarkerArray__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {stamp_markerarray__msg__StampedMarkerArray__FIELD_NAME__markers, 7, 7},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription stamp_markerarray__msg__StampedMarkerArray__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {stamp_markerarray__msg__StampedMarkerArray__TYPE_NAME, 40, 40},
      {stamp_markerarray__msg__StampedMarkerArray__FIELDS, 2, 2},
    },
    {stamp_markerarray__msg__StampedMarkerArray__REFERENCED_TYPE_DESCRIPTIONS, 12, 12},
  };
  if (!constructed) {
...
stamp_markerarray__msg__StampedMarkerArray__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *stamp_markerarray__msg__StampedMarkerArray__get_individual_type_description_source(NULL),
